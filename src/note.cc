...
const char* noteboard_name [ MAX_NOTEBOARD ] = { "general", "immortal",
  "ideas",
  "bugs", "jobs", "announcements", "information", "stories", "softcode",
...
inline int noteboard_level( int board )
{
  if( board == NOTE_IMMORTAL || board == NOTE_JOBS
    || board == NOTE_BUILDER || board ==
NOTE_DEVELOPMENT || board == NOTE_CODE || board == NOTE_SOFTCODE )
...
{
  if( !is_immortal( ch ) && ( i == NOTE_IMMORTAL || i == NOTE_JOBS
