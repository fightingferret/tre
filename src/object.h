...
#define OFLAG_COOKIE               40
#define OFLAG_RUG                  41
#define OFLAG_PLR_NO_SELL          42
#define MAX_OFLAG                  43

#define OFLAG_IN_USE               ( MAX_OFLAG )
#define MAX_TEMPORARY_OFLAG        ( MAX_OFLAG + 1)
...
extern const char* Obj_the_Name( obj_data* );
...
void        replace_obj        ( obj_data*, obj_data* );
...
bool  split_money       ( char_data*, int, bool );
